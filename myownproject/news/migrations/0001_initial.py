...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_news', (
            ...
            ('news_body', self.gf('django.db.models.fields.CharField')(max_length=5000)),
        ))
        db.send_create_signal(u'news', ['News'])

        # Adding M2M table for field tags on 'News'
        m2m_table_name = db.shorten_name(u'news_news_tags')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'news_news_tags'))
    ...
    models = {
        ...
        u'news.news': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['news.Tag']", 'symmetrical': 'False'}),
